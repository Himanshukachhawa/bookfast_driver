...
import { StyleSheet, Text, View, FlatList, SafeAreaView, ScrollView, TouchableOpacity, I18nManager, Platform } from 'react-native';
          ...
          <FlatList
            ...
            renderItem={({ item,index }) => (
              <TouchableOpacity onPress={() => this.navigate(item.route)}>
                <View style={{ width:'100%' , flexDirection:'row', padding:10, borderBottomWidth:0.3, borderColor:colors.theme_fg_four}}>
                  <View style={{ width:'15%', alignItems:'flex-start', justifyContent:'center'}}>
                    <View style={styles.icon_button}>
                    <Icon type={Icons.FontAwesome} name={item.icon} color={colors.theme_bg_three} style={{ fontSize:12 }} />
                    </View>
                  </View>
