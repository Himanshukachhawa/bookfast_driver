...
import Incentive from "./src/views/Incentive";
    ...
    <NavigationContainer linking={linking}>
      ...
      >
        ...
        <Stack.Screen
          name="Login"
          component={Login}
          options={{ title: strings.enter_your_mobile_number }}
        />
        <Stack.Screen
          name="LoginHome"
          component={LoginHome}
        ...
        <Stack.Screen
          name="Password"
          component={Password}
          options={{ title: strings.enter_your_password }}
        />
        <Stack.Screen
          name="Trip"
          component={Trip}
        ...
        <Stack.Screen
          ...
          options={{ title: strings.notification }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          name="Training"
          component={Training}
          options={{ title: strings.training }}
        />
        <Stack.Screen
          name="EditFirstName"
          component={EditFirstName}
          options={{ title: strings.first_name }}
        />
        <Stack.Screen
          name="EditLastName"
          component={EditLastName}
          options={{ title: strings.last_name }}
        />
        <Stack.Screen
          name="EditPhoneNumber"
          component={EditPhoneNumber}
          options={{ title: strings.edit_phone_number }}
        />
        <Stack.Screen
          name="EditEmail"
          component={EditEmail}
          options={{ title: strings.email }}
        />
        <Stack.Screen
          name="EditPassword"
          component={EditPassword}
          options={{ title: strings.edit_password }}
        />
        <Stack.Screen
          name="Faq"
          component={Faq}
          options={{ title: strings.faq }}
        />
        <Stack.Screen
          name="FaqDetails"
        ...
        <Stack.Screen
          name="Wallet"
          component={Wallet}
          options={{ title: strings.wallet }}
        />
        <Stack.Screen
          name="Incentive"
          component={Incentive}
          options={{ title: "Incentive" }}
        />
        ...
        <Stack.Screen
          name="Earnings"
          component={Earnings}
          options={{ title: strings.earnings }}
        />
        <Stack.Screen
          name="KycVerification"
          component={KycVerification}
          options={{ title: strings.kyc_verification }}
        />
        <Stack.Screen
          name="Withdrawal"
          component={Withdrawal}
          options={{ title: strings.withdrawal }}
        />
        <Stack.Screen
          name="Logout"
          component={Logout}
        ...
        <Stack.Screen
          name="DutyTypes"
          component={DutyTypes}
          options={{ title: "Duty Types" }}
        />
        <Stack.Screen
          name="Document"
          component={Document}
          options={{ title: strings.document }}
        />
        <Stack.Screen
          name="VehicleDetails"
